...
public class PdrawSyntaxMain {
    public static void main(String[] args) throws Exception {
        ...
        // pdrawVisitor_Semantic_Check semantic_Checker = new pdrawVisitor_Semantic_Check();
        // semantic_Checker.visitProgram(programContext);

        pdrawVisitor_Syntax_Check semantic_Check = new pdrawVisitor_Syntax_Check();
